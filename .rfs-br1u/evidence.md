...
| C5 | cleanup_revalidates_each_destructive_target | Omitting delete-boundary validation deleted a target whose ownership changed after preflight; independent store lookup proved it gone. | PASS for all six target families with same-target restored-ownership controls |
