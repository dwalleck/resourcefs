...
**Wall budget/phase:** Always-on for every `rfs_write`. Local MCP overhead budget 10 ms ordinary/100 ms at maximum input; total network-backed budgets remain S5 (60,000 ms title/body; 90,000 ms comment) and S6 (30,000 ms Creation).
